...
def test_conus_selection_excludes_other_domains_and_gifs():
    ...
    assert CONUS_RECONCILIATION_GRIB2.fullmatch("st4_conus.2026081212.06h.grb2")
    assert not CONUS_RECONCILIATION_GRIB2.fullmatch("st4_conus.2026081212.24h.grb2")
